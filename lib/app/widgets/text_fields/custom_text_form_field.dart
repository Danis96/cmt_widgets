...
class AW_TextFormField extends StatefulWidget {
  const AW_TextFormField({
    Key? key,
    this.label = '',
    this.hintText,
    this.controller,
  ...
  @override
  _AW_TextFormFieldState createState() => _AW_TextFormFieldState();
}

class _AW_TextFormFieldState extends State<AW_TextFormField> {
  bool filled = true;
  bool _obscure = true;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        if (widget.label != null) _buildFieldLabel(widget.label!, style: widget.labelStyle),
        _buildTextFormField(
          context: context,
...
Widget _buildTextFormField(
  ...
  return SizedBox(
    ...
    child: TextFormField(
      ...
      textInputAction: textInputAction,
      onFieldSubmitted: onFieldSubmitted ?? (String? s) => FocusScope.of(context).nextFocus(),
    ),
  );
}
