        ...
        actions: <Widget>[
          Container(
              ...
              child: buttonTwoText.isEmpty
                  ...
                  : _buildTwoButtons(context, buttonText: buttonText, buttonTwoText: buttonTwoText, onPressed: onButtonPressed, onButtonTwoPressed: onButtonTwoPressed)),
        ],
      ),
    ),
  );
