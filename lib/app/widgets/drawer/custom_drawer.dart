...
class AW_CustomDrawer extends StatelessWidget {
  const AW_CustomDrawer({
  ...
  final List<AW_DrawerListItem>? listItems;
  final Key? widgetKey;
  final Key? actionKey;
          ...
          children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: GestureDetector(key: actionKey, onTap: () => onActionIconPress!(), child: Icon(actionIcon!, color: actionIconColor)),
                      ),
                    ],
                  ),
            ),
            Expanded(
              child: ListView(
                  ...
                  children: listItems!.mapIndex((AW_DrawerListItem item, int index) {
                    return _tapItem(
                        wrapWithMaterial,
                        AW_DrawerListItem(
...
Widget _buildLogout({BuildContext? context, String? logoutTitle, Function? logoutPress, TextStyle? logoutStyle, Color logoutTitleColor = Colors.white}) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: <Widget>[
