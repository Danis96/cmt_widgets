...
class AW_SwitchWithTitleDescription extends StatelessWidget {
  const AW_SwitchWithTitleDescription({
    Key? key,
  ...
  Widget _textAndInfo(BuildContext context) {
    return Row(
      children: <Widget>[
        ...
        IconButton(key: const Key('switch_w_title_desc_icon'), onPressed: () => onIconPressed != null ? onIconPressed!() : null, icon: icon),
      ],
    );
  }
